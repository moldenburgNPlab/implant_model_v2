...
def fig9_summary():
    ...
    # Layout figure
    fig1, axs1 = plt.subplots(4, 2, figsize=(8, 8))
    ...
    for idx, scen in enumerate(scenarios[n_artscen:]):  # Panel A
        ...
        axs1[0, 0].plot(x, y, '.', color=fig9_colors[idx, :], markersize=5)
    ...
    for idx, scen in enumerate(scenarios[n_artscen:]):  # Panel C
        ...
        axs1[1, 0].plot(x, y, '.', color=fig9_colors[idx, :], markersize=5)
    ...
    for idx, scen in enumerate(scenarios[n_artscen:]):  # Panel B
        ...
        axs1[0, 1].plot(x, y, '.', color=fig9_colors[idx, :], markersize=5)
    ...
    for idx, scen in enumerate(scenarios[n_artscen:]):  # Panel D
        ...
        axs1[1, 1].plot(x, y, '.', color=fig9_colors[idx, :], markersize=5)
    ...
    for idx, scen in enumerate(scenarios[n_artscen:]):  # Panel E
        ...
        axs1[2, 0].plot(ct_dist, fit_dist, '.', color=fig9_colors[idx, :], markersize=5)
        ...
        if plot_indiv:
            ...
            minx = np.min(ct_dist)
            maxx = np.max(ct_dist)
            axs1[2, 0].plot((minx, maxx), (minx*slope + intercept, maxx*slope + intercept), '-', c=fig9_colors[idx, :],
    ...
    for idx, scen in enumerate(scenarios[n_artscen:]):  # Panel F
        ...
        retval = subject_data.subj_thr_data(scen)
        espace = retval[3]
        axs1[2, 1].plot(ct_dist, fit_dist, '.', color=fig9_colors[idx, :], markersize=5)
        ...
        if plot_indiv:
            ...
            minx = np.min(ct_dist)
            maxx = np.max(ct_dist)
            axs1[2, 1].plot((minx, maxx), (minx*slope + intercept, maxx*slope + intercept), '-', c=fig9_colors[idx, :],
                            linewidth=0.5)  # plot line
    ...
    for idx, scen in enumerate(scenarios[n_artscen:]):  # Panel G
        ...
        retval = subject_data.subj_thr_data(scen)
        espace = retval[3]
        axs1[3, 0].plot(fit_dist, fit_err, '.', color=fig9_colors[idx, :], markersize=5)
        ...
        if plot_indiv:
            ...
            axs1[3, 0].plot((minx, maxx), (minx*slope + intercept, maxx*slope + intercept), '-', c=fig9_colors[idx, :],
                            linewidth=0.5)  # plot line
    ...
    for idx, scen in enumerate(scenarios[n_artscen:]):  # Panel H
        ...
        retval = subject_data.subj_thr_data(scen)
        espace = retval[3]
        axs1[3, 1].plot(fit_dist, fit_err, '.', color=fig9_colors[idx, :], markersize=5)
        ...
        if plot_indiv:
            ...
            minx = np.min(fit_dist)
            maxx = np.max(fit_dist)
            axs1[3, 1].plot((minx, maxx), (minx*slope + intercept, maxx*slope + intercept), '-', c=fig9_colors[idx, :],
                            linewidth=0.5)  # plot line
