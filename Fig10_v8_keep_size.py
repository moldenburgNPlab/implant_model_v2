...
def fig10_summary():
    ...
    # Layout figure
    fig1, axs1 = plt.subplots(4, 2, figsize=(8, 8), gridspec_kw={'height_ratios': [1, 1, 3, 3]})
    fig1.tight_layout(pad=3)

    plt.figtext(0.0, 0.975, 'A', color='black', size=20, weight='bold')
    plt.figtext(0.475, 0.975, 'B', color='black', size=20, weight='bold')
    plt.figtext(0.0, 0.78, 'C', color='black', size=20, weight='bold')
    plt.figtext(0.475, 0.78, 'D', color='black', size=20, weight='bold')
    plt.figtext(0.0, 0.62, 'E', color='black', size=20, weight='bold')
    plt.figtext(0.475, 0.62, 'F', color='black', size=20, weight='bold')
    plt.figtext(0.0, 0.3, 'G', color='black', size=20, weight='bold')
    plt.figtext(0.475, 0.3, 'H', color='black', size=20, weight='bold')
    ...
    for idx, scen in enumerate(scenarios[n_artscen:]):  # Panel A
        ...
        axs1[0, 0].set_ylabel('Fit mono. thr. (dB)', labelpad=-1)
        ...
        axs1[0, 0].set_yticks([-20, -10, 0, 10])
    ...
    for idx, scen in enumerate(scenarios[n_artscen:]):  # Panel B
        ...
        axs1[0, 1].set_ylabel('Fit mono. thr. (dB)', labelpad=-2)
        ...
        axs1[0, 1].set_yticks([-20, -10, 0, 10])
    ...
    for idx, scen in enumerate(scenarios[n_artscen:]):  # Panel D
        ...
        axs1[1, 1].set_ylabel('Fit trip. thr. (dB)', labelpad=-2)
